...
tmp<volScalarField>
kOmegaSSTincom<BasicTurbulenceModel>::kOmegaSSTincom::F1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTincom<BasicTurbulenceModel>::kOmegaSSTincom::F2() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTincom<BasicTurbulenceModel>::kOmegaSSTincom::F3() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTincom<BasicTurbulenceModel>::kOmegaSSTincom::F23() const
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTincom<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTincom<BasicTurbulenceModel>::Pk
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTincom<BasicTurbulenceModel>::epsilonByk
(
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaSSTincom<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaSSTincom<BasicTurbulenceModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaSSTincom<BasicTurbulenceModel>::Qsas
(
...
template<class BasicTurbulenceModel>
kOmegaSSTincom<BasicTurbulenceModel>::kOmegaSSTincom
(
...
kOmegaSSTincom<BasicTurbulenceModel>::R() const
{
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volSymmTensorField>
kOmegaSSTincom<BasicTurbulenceModel>::devRhoReff() const
{
...
kOmegaSSTincom<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
...
//**************************************************************************//
template<class BasicTurbulenceModel>
bool kOmegaSSTincom<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTincom<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
